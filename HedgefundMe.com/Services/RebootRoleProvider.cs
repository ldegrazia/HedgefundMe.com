...
{
    public class RebootRoleProvider : RoleProvider
    {
        ...
        /// </summary>
        public RebootRoleProvider()
        {
            _userSvc = new UserService(_appName);
        }
        public RebootRoleProvider(string applicationName)
        {
        ...
        /// <summary>
        /// Remvoes a user from all roles, leaves readonly users in readonly roles alone
        /// </summary>
        /// <param name="userId"></param>
        ...
        public string CreateNewAdmin(string newAppName)
        {
            ...
            try
            {
                ...
                _db.Users.Add(admin);
                _db.SaveChanges();
                _db.Roles.Add(RebootRoleProvider.CreateAdminRole(newAppName));  //Create the Administrators Role
                _db.Roles.Add(RebootRoleProvider.CreateUsersRole(newAppName));  //Create the users role
                _db.SaveChanges();
                //add the admin
