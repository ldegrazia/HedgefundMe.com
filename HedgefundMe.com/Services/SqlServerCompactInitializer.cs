...
namespace HedgefundMe.com.Services
{
    ...
    public static class SqlServerCompactInitializer
    {
         ...
         public static SqlCeParameter AddParameter(SqlCeCommand cmd, string name)
        {
            var param1 = cmd.CreateParameter();
            param1.ParameterName = name;
            return param1;
        }
        public static void AddParameterString(SqlCeCommand cmd, string name)
        {
            var param1 = AddParameter(cmd,name); 
            // assign col2 types, constraints, lengths here.
            cmd.Parameters.Add(param1);
        }
        public static void AddParameterInt(SqlCeCommand cmd, string name)
        {
            var param1 = AddParameter(cmd, name); 
        ...
        public static void AddParameterDouble(SqlCeCommand cmd, string name)
        {
            var param1 = AddParameter(cmd, name); 
        ...
        public static void AddParameterDate(SqlCeCommand cmd, string name)
        {
            var param1 = AddParameter(cmd, name); 
